        ...
        <div className={"RandomPromptSuggestor"}>
            <div>
                ...
                <div className={"RandomPromptSuggestorButtonsContainer"}>
                    <button onClick={async () => updatePrompt(PromptType.CHARACTER)}>Character</button>
                    <button onClick={async () => updatePrompt(PromptType.EMOTION)}>Emotion</button>
                    <button onClick={async () => updatePrompt(PromptType.LINE)}>Line</button>
                    <button onClick={async () => updatePrompt(PromptType.LOCATION)}>Location</button>
                    <button onClick={async () => updatePrompt(PromptType.RELATIONSHIP)}>Relationship</button>
                </div>
            </div>
            <h1>{prompt}</h1>
        </div>
